...
# https://github.com/philipperemy/n-beats/blob/master/examples/trainer_pytorch.py
...
class NBeatsNet(nn.Module):
    ...
    def compile(self, loss: str, optimizer: Union[str, Optimizer]):
        ...
        if isinstance(optimizer, str):
            ...
            opt_ = opt_(lr=self.learning_rate, params=self.parameters(), weight_decay=self.weight_decay)
        else:
            opt_ = optimizer
        self._opt = opt_
        self._loss = loss_
