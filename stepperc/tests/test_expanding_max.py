...
from crptmidfreq.stepperc.incr_expanding_max import *

# pytest ./crptmidfreq/stepperc/tests/test_expanding_max.py --pdb --maxfail=1
...
def test_against_pandas():
    ...
    sss = MaxStepper(folder='test_data', name='test_ewm')
