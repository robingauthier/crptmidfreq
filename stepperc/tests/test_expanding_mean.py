...
from crptmidfreq.stepper.incr_expanding_mean import *
from crptmidfreq.stepper.tests.test_incr_ewm import generate_data

# pytest ./crptmidfreq/stepper/tests/test_expanding_mean.py --pdb --maxfail=1
...
def test_against_pandas():
    ...
    sss = ExpandingMeanStepper(folder='test_data', name='test_ewm')
